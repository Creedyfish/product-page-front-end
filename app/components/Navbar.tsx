  ...
  return (
    ...
    >
      <NavbarContent justify="center" className="">
        ...
        <NavbarBrand className="">
          <div className="flex h-full w-full items-center justify-center">
            <svg
              className="fill-neutral-dark-grayish-black dark:fill-neutral-white"
              width="138"
              height="20"
      ...
      <NavbarContent
        ...
        justify="center"
      >
        <NavbarItem isActive={activeItem === "Collections"} className="">
          <Link
            color="foreground"
            className=""
            href="#"
      ...
      <NavbarContent justify="end" className="gap-5">
        <Dropdown>
          ...
          <DropdownMenu aria-label="Dynamic Actions " className="bg-none">
              ...
              <DropdownItem key={item.id} className="">
                <div className="flex items-center justify-center gap-2 text-sm ">
                  ...
                  <Button
                    ...
                    className="w-15 min-w-0 hover:bg-red-500"
                  >
                    <Image
                      radius="none"
                      width={15}
            ...
            {cart.length > 0 ? (
              <DropdownItem>
                <Button className="w-full bg-primary-orange">Checkout</Button>
              </DropdownItem>
            ) : (
              []
            )}
      ...
      <NavbarMenu className="w-2/3  font-bold outline-none">
        <ThemeSwitcher />
